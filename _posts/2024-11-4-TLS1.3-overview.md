...
image: /assets/article/reseau/tls/2024-11-4-TLS1.3-overview-mindmap.png
isMath: true
---
...
| ----------- | ---- | ------------------------------------------------------------ |
| TLS v1.0    | 1999 |                                                              |
| TLS v1.1    | 2006 | [RFC 4346](https://www.rfc-editor.org/rfc/rfc4346.txt). Tried to fix padding<br/>oracle attacks when using CBC<br/>mode. |
| TLS v1.2    | 2008 | [RFC 5246](https://datatracker.ietf.org/doc/html/rfc5246) and RFC [6176](https://www.rfc-editor.org/info/rfc6176/). |
| TLS v1.3    | 2018 | [RFC 8446](https://datatracker.ietf.org/doc/html/rfc8446). Clean, fresh design.<br/>Four years of work. The most se-<br/>cure version. |
...
![TLS 1.3 overview mindmap]({{site.url_complet}}/assets/article/reseau/tls/2024-11-4-TLS1.3-overview-mindmap.png)

...
description: Virtuals Protocol is building the co-ownership layer for AI agents in gaming and entertainment. These agents can operate across a wide range of applications and games, significantly expanding their revenue surface area. Like any other productive asset, they enable these AI agents to be tokenized and co-owned via blockchain.
...
- Unlike other chatbots, VIRTUAL Agent comes with a rigged 3D character with animation and facial expressions. VIRTUAL can be built using 3D editor that supports MMD file format. 
